...
- Shuffle hero images: use a different truck/freight image on each page's hero

## Steps
- [x] 1. Update TODO.md with plan
- [ ] 2. Fix index.html broken img tags (hero/about/fleet sections)
- [x] 3. Rebrand about.html (title, logo, top bar, hero + image, content, timeline/geography, footer, CTAs, social removal)
- [ ] 4. Rebrand services.html (title, logo, top bar, hero + image swap, content, coverage areas, footer, CTAs, social removal)
...
- [ ] services.html: rebrand title, top bar, logo, nav, hero image → `photo-1553413077`, content, coverage areas, CTA, footer, social removal
...
- about.html → `photo-1504328345606` (truck fleet)
- services.html → `photo-1553413077` (truck)
- fleet.html → `photo-1605812860427` (truck)
- contact.html → `photo-1494412574643` (truck on road)
- get-a-quote.html → `photo-1519415943484` (truck)
